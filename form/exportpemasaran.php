<?php
    ...
    class PDF extends FPDF
    {
       ...
       //Pengaturan Font Header = jenis font : Times New Romans, Bold, ukuran 14
            ...
            $this->Cell(16,1,'Laporan Data Pemasaran','TBLR',0,'C',1);
        }
    ...
    $pdf->Cell(2,1,'Id Pemesanan','LRTB',0,'C');
    $pdf->Cell(2,1,'id Produk','LRTB',0,'C');
    $pdf->Cell(4,1,'Deskripsi','LRTB',0,'C');
    $pdf->Cell(3,1,'Harga','LRTB',0,'C');
    $pdf->Cell(4,1,'Promo','LRTB',0,'C');
    ...
    {   
        ...
        $pdf->Cell(2,1,$cell[$j][2],'LBTR',0,'L');
