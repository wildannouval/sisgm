<?php
    ...
    class PDF extends FPDF
    {
       ...
       //Pengaturan Font Header = jenis font : Times New Romans, Bold, ukuran 14
            ...
            $this->Cell(19,1,'Laporan Data Perusahaan','TBLR',0,'C',1);
        }
    ...
    $pdf->Cell(3,1,'ID Perusahaan','LRTB',0,'C');
    $pdf->Cell(3,1,'Nama Perusahaan','LRTB',0,'C');
    $pdf->Cell(4,1,'No Tlp Perusahaan','LRTB',0,'C');
    $pdf->Cell(4,1,'Alamat Perusahaan','LRTB',0,'C');
    $pdf->Cell(4,1,'Laporan','LRTB',0,'C');
    ...
    {   
        ...
        $pdf->Cell(3,1,$cell[$j][2],'LBTR',0,'L');
        $pdf->Cell(4,1,$cell[$j][3],'LBTR',0,'L');
