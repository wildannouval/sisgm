<?php
    ...
    class PDF extends FPDF
    {
       ...
       //Pengaturan Font Header = jenis font : Times New Romans, Bold, ukuran 14
            ...
            $this->Cell(30,1,'Laporan Data Pengiriman','TBLR',0,'C',1);
        }
    ...
    $pdf->Cell(3,1,'No Pengiriman','LRTB',0,'C');
    $pdf->Cell(2,1,'No Invoice','LRTB',0,'C');
    $pdf->Cell(3,1,'Nama Penerima','LRTB',0,'C');
    $pdf->Cell(3,1,'Alamat Penerima','LRTB',0,'C');
    $pdf->Cell(3,1,'Nama Produk','LRTB',0,'C');
    $pdf->Cell(3,1,'QTY Produk','LRTB',0,'C');
    $pdf->Cell(2,1,'Total','LRTB',0,'C');
    $pdf->Cell(2,1,'Keterangan','LRTB',0,'C');
    $pdf->Cell(3,1,'Eqpt_pengiriman','LRTB',0,'C');
    $pdf->Cell(2,1,'Terms','LRTB',0,'C');
    $pdf->Cell(2,1,'Nama Sopir','LRTB',0,'C');
    ...
    {   
        ...
        $pdf->Cell(2,1,$cell[$j][3],'LBTR',0,'L');
        $pdf->Cell(3,1,$cell[$j][5],'LBTR',0,'L');
        ...
        $pdf->Cell(3,1,$cell[$j][12],'LBTR',0,'C');
        $pdf->Cell(2,1,$cell[$j][13],'LBTR',0,'C');
        $pdf->Cell(2,1,$cell[$j][14],'LBTR',0,'C');
