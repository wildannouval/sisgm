                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        while($row = mysqli_fetch_assoc($result)){
                                            ...
                                            <td>$row[stock]</td>
                                            <td>
                                            <a href='../form/stok_edit.php?id_stok=$row[id_stok]' class='btn btn-warning'>Edit</a>
                                            <a href='../form/stok_delete.php?id_stok=$row[id_stok]' class='btn btn-danger'>Delete</a>
                                            </td>
                                        </tr>
                                        ";
                                        }
