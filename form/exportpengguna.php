<?php
    ...
    class PDF extends FPDF
    {
       ...
       //Pengaturan Font Header = jenis font : Times New Romans, Bold, ukuran 14
            ...
            $this->Cell(19,1,'Laporan Data Pengguna','TBLR',0,'C',1);
        }
    ...
    {   
        ...
        $pdf->Cell(1,1,$cell[$j][1],'LBTR',0,'L');
