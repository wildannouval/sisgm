...
if(isset($_POST['submit'])){
  ...
  $query = mysqli_query($conn,"INSERT INTO transaksi (tgl_invoice,nama_customer,no_hp_customer,id_produk,nama_produk,qty_produk,harga_produk,total) VALUES ('$tgl_invoice','$nama_customer','$no_hp_customer','$id_produk','$nama_produk','$qty_produk','$harga_produk','$total')");
  if($query){
        ...
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4 inputGroupContainer">
              <div class="input-group">
                ...
                <input name="tgl_invoice" placeholder="Tanggal Invoice" class="form-control" type="date">
              </div>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-4 inputGroupContainer">
              <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                <input name="no_hp_customer" placeholder="no hp customer" class="form-control" type="text">
              </div>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-4 inputGroupContainer">
              <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                <input name="qty_produk" placeholder="qty produk" class="form-control" type="text">
              </div>
            </div>
          </div>
          <div class="form-group">
