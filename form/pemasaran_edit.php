...
$query=mysqli_query($conn,"SELECT * FROM pemasaran");
        ...
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4 inputGroupContainer">
              <div class="input-group">
                ...
                <textarea name="deskripsi" placeholder="deskripsi" class="form-control" rows="3"><?php echo $data['deskripsi'];?></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4 inputGroupContainer">
              <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                <input name="harga" placeholder="harga" class="form-control" type="text" value="<?php echo $data['harga']; ?>">
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4 inputGroupContainer">
              <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                <textarea name="promo" placeholder="promo" class="form-control" rows="3"><?php echo $data['promo'];?></textarea>
              </div>
            </div>
          </div>
