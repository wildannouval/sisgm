<?php
    ...
    class PDF extends FPDF
    {
       ...
       //Pengaturan Font Header = jenis font : Times New Romans, Bold, ukuran 14
            ...
            $this->Cell(15,1,'Laporan Data Pelayanan','TBLR',0,'C',1);
        }
    ...
    $pdf->Cell(3,1,'Id Pelayanan','LRTB',0,'C');
    $pdf->Cell(3,1,'Nama Customer','LRTB',0,'C');
    $pdf->Cell(4,1,'Keluhan','LRTB',0,'C');
    $pdf->Cell(4,1,'Solusi','LRTB',0,'C');
